...
export default function RepoDetail({ repo, onBack }) {
  ...
  return (
    <div style={{ padding: "32px", fontFamily: "sans-serif", maxWidth: "1100px", margin: "0 auto", color: "#1a1a1a", background: "#f0f0f0", minHeight: "100vh" }}>
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.4)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000 }}>
          <div style={{ background: "white", borderRadius: "10px", padding: "28px", width: "440px", color: "#1a1a1a" }}>
            ...
            <div style={{ marginBottom: "14px" }}>
              ...
              <input type="file" accept=".docx,.pdf,.png,.pptx" onChange={e => { setForm({ ...form, file: e.target.files[0] }); setSelectedFileName(e.target.files[0]?.name || ""); }} style={{ marginTop: "6px" }} />
              {selectedFileName && <div style={{ marginTop: "6px", fontSize: "13px", color: "#333" }}>📎 {selectedFileName}</div>}
            </div>
            <div style={{ marginBottom: "14px" }}>
              <label style={{ fontSize: "13px", color: "#555" }}>Artifact Type</label><br />
              <select value={form.artifact_type} onChange={e => setForm({ ...form, artifact_type: e.target.value })} style={{ marginTop: "6px", width: "100%", padding: "8px", borderRadius: "6px", border: "1px solid #ddd", color: "#1a1a1a" }}>
            ...
            {form.linked_to === "account" && (
              <div style={{ marginBottom: "14px" }}>
                ...
                <select value={form.account_id} onChange={e => setForm({ ...form, account_id: e.target.value })} style={{ marginTop: "6px", width: "100%", padding: "8px", borderRadius: "6px", border: "1px solid #ddd", color: "#1a1a1a" }}>
            ...
            <div style={{ display: "flex", gap: "10px", justifyContent: "flex-end", marginTop: "20px" }}>
              ...
              <button onClick={handleUpload} disabled={uploading} style={{ padding: "8px 16px", background: "#1a1a1a", color: "white", border: "none", borderRadius: "6px", cursor: "pointer" }}>
